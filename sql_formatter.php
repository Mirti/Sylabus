...
session_start();
	...
	$sql_query="SELECT p.nazwa, p.typ_zajec, n.imie,n.nazwisko, r.rok, r.kierunek FROM przedmiot p, prowadzacy n, rocznik r, wydzial w, przedmiot_prowadzacy pp WHERE r.wydzial_id=w.wydzial_id AND p.rocznik_id=r.rocznik_id and p.przedmiot_id=pp.przedmiot_id AND n.prowadzacy_id=pp.przedmiot_id ";
